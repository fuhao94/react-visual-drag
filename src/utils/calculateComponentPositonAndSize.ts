import { CalculateComponentMethod, PointPosType } from '@/types';

import { calculateRotatedPointCoordinate, getCenterPoint } from './translate';

const calculateLeftTop: CalculateComponentMethod = (
  style,
  curPosition,
  proportion,
  needLockProportion,
...
const calculateRightTop: CalculateComponentMethod = (
  style,
  curPosition,
  proportion,
  needLockProportion,
...
const calculateRightBottom: CalculateComponentMethod = (
  style,
  curPosition,
  proportion,
  needLockProportion,
...
const calculateLeftBottom: CalculateComponentMethod = (
  style,
  curPosition,
  proportion,
  needLockProportion,
...
const calculateTop: CalculateComponentMethod = (
  style,
  curPosition,
  proportion,
  needLockProportion,
...
const calculateRight: CalculateComponentMethod = (
  style,
  curPosition,
  proportion,
  needLockProportion,
...
const calculateBottom: CalculateComponentMethod = (
  style,
  curPosition,
  proportion,
  needLockProportion,
...
const calculateLeft: CalculateComponentMethod = (
  style,
  curPosition,
  proportion,
  needLockProportion,
...
const funMap: Record<PointPosType, CalculateComponentMethod> = {
  lt: calculateLeftTop,
  t: calculateTop,
...
export default function calculateComponentPositionAndSize(
  ...
  funMap[name](style, curPosition, proportion, needLockProportion, pointInfo);
}
